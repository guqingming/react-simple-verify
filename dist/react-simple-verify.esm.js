...
var ReactSimpleVerify = (function (_super) {
    ...
    ReactSimpleVerify.prototype.render = function () {
        ...
        return (createElement("div", { style: this.style, className: "simple-verify" },
            createElement("div", { className: "verify-tips" }, this.props.tips),
            createElement("div", { style: this.slideBoxStyle, className: "verify-box" },
                createElement("div", { style: slideStyle, className: "veriry-slide" })),
            createElement("div", { className: "verify-bar", onMouseEnter: this.mouseenter.bind(this), onMouseLeave: this.mouseleave.bind(this), onMouseDown: this.mousedown.bind(this) },
                createElement("div", { style: barStyle, className: "icon" })),
            createElement("div", { style: textStyle, className: "verify-success-tips" },
                createElement("span", { style: this.iconStyle }),
